...
-g^{{\mu}{\eta}}g_{{{\zeta}}{{\rho}^{\prime}}}g^{{{\rho}^{\prime}}{{\tau}^{\prime}}}(2q_i+q)^{\zeta}(q-q_j)^{{\delta}}
...
+g^{{\eta}{\zeta}}g_{{{\zeta}}{{\rho}^{\prime}}}g^{{{\rho}^{\prime}}{{\tau}^{\prime}}}(2q +q_i)^{\mu}(q-q_j)^{{\delta}}\\
...
+g^{{\zeta}{\mu}}g_{{{\zeta}}{{\rho}^{\prime}}}g^{{{\rho}^{\prime}}{{\tau}^{\prime}}}(q_i -q)^{\eta}(q-q_j)^{{\delta}})]
\end{split}
\end{equation}
...
+g^{{{\tau}^{\prime}}{{\delta}}}(2q +q_i)^{\mu}(2q_j+q)^{{\eta}}-g^{{\eta}{\delta}}(2q +q_i)^{\mu}(2q +q_j)^{{\tau}^{\prime}}+g^{{{\eta}}{{\tau}^{\prime}}}(2q +q_i)^{\mu}(q-q_j)^{{\delta}}\\
+g^{{{\tau}^{\prime}}{{\delta}}}(2q_j+q)^{{\mu}}(q_i -q)^{\eta}-g^{{\mu}{\delta}}(q_i -q)^{\eta}(2q +q_j)^{{\tau}^{\prime}}+g^{{{\mu}}{{\tau}^{\prime}}}(q_i -q)^{\eta}(q-q_j)^{{\delta}})]
\end{split}
\end{equation}
...
\begin{split}
M_1{M_2}^{\dagger}=\frac{g_s^2 f^{\:a\:l\:o} f^{\:f\:n\: o}}{(q_i +q)^2 (q_j +q)^2}\\
[-{g_{{\eta}^{\prime}}}^{\eta}{g_{{\gamma}}}^{\delta}(2q_i+q) \cdot (2q_j+q)+{g_{{\eta}^{\prime}}}^{\eta}(2q +q_j)_{{\gamma}}(2q_i+q)^{\delta}-{g_{{\eta}^{\prime}}}^{\eta}(2q_i +q)_{{\gamma}}(q-q_j)^{{\delta}}\\
+{g_{{\gamma}}}^{\delta}(2q +q_i)_{{\eta}^{\prime}}(2q_j+q)^{{\eta}}-g^{{\eta}{\delta}}(2q +q_i)_{{\eta}^{\prime}}(2q +q_j)_{{\gamma}}+{g_{{\gamma}}}^{\eta}(2q +q_i)_{{\eta}^{\prime}}(q-q_j)^{{\delta}}\\
+{g_{{\gamma}}}^{\delta}(2q_j+q)_{{\eta}^{\prime}}(q_i -q)^{\eta}-{g_{{{\eta}^{\prime}}}}^{\delta}(q_i -q)^{\eta}(2q +q_j)_{{\gamma}}+g_{{{\gamma}}{{\eta}^{\prime}}}(q_i -q)^{\eta}(q-q_j)^{{\delta}}]
\end{split}
\end{equation}

\begin{equation}
\begin{split}
M_1{M_2}^{\dagger}=\frac{g_s^2 f^{\:a\:l\:o} f^{\:f\:n\: o}}{4(q_i \cdot q) (q_j \cdot q)}\\
[
-{g_{{\eta}^{\prime}}}^{\eta}{g_{{\gamma}}}^{\delta}(2q_i+q) \cdot (2q_j+q)+{g_{{\eta}^{\prime}}}^{\eta}[(2q +q_j)_{{\gamma}}(2q_i+q)^{\delta}-(2q_i +q)_{{\gamma}}(q-q_j)^{{\delta}}]\\
+{g_{{\gamma}}}^{\delta}[(2q +q_i)_{{\eta}^{\prime}}(2q_j+q)^{{\eta}}+(2q_j+q)_{{\eta}^{\prime}}(q_i -q)^{\eta}]-g^{{\eta}{\delta}}(2q +q_i)_{{\eta}^{\prime}}(2q +q_j)_{{\gamma}}\\+{g_{{\gamma}}}^{\eta}(2q +q_i)_{{\eta}^{\prime}}(q-q_j)^{{\delta}}-{g_{{{\eta}^{\prime}}}}^{\delta}(q_i -q)^{\eta}(2q +q_j)_{{\gamma}}+g_{{{\gamma}}{{\eta}^{\prime}}}(q_i -q)^{\eta}(q-q_j)^{{\delta}}]
\end{split}
\end{equation}
...
M_1{M_2}^{\dagger}=\frac{g_s^2 f^{\:a\:l\:o} f^{\:f\:n\: o}}{4(q_i \cdot q) (q_j \cdot q)}\\
[
-{g_{{\eta}^{\prime}}}^{\eta}{g_{{\gamma}}}^{\delta}( 2q\cdot q_i+ q\cdot q+4q_j \cdot q_i+2q_j \cdot q)+{g_{{\eta}^{\prime}}}^{\eta}[2q_{{\gamma}}{q_i}^{\delta}+q_{{\gamma}}{q}^{\delta}+4{q_j}_{{\gamma}}{q_i}^{\delta}+2{q_j}_{{\gamma}}{q}^{\delta}]\\
+{g_{{\gamma}}}^{\delta}[2q_{{\eta}^{\prime}}{q_i}^{{\eta}}+q_{{\eta}^{\prime}}{q}^{{\eta}}+4{q_j}_{{\eta}^{\prime}}{q_i}^{{\eta}}+2{q_j}_{{\eta}^{\prime}}{q}^{{\eta}}]-g^{{\eta}{\delta}}(2q +q_i)_{{\eta}^{\prime}}(2q +q_j)_{{\gamma}}\\+{g_{{\gamma}}}^{\eta}(2q +q_i)_{{\eta}^{\prime}}(q-q_j)^{{\delta}}-{g_{{{\eta}^{\prime}}}}^{\delta}(q_i -q)^{\eta}(2q +q_j)_{{\gamma}}+g_{{{\gamma}}{{\eta}^{\prime}}}(q_i -q)^{\eta}(q-q_j)^{{\delta}}]
\end{split}
\end{equation}
...
\begin{equation}
\begin{split}
{k_1}^{{\eta}}{k_1}^{{\eta}^{\prime}}&={\alpha_1}^2\: {p_i}^{{\eta}}{p_i}^{{\eta}^{\prime}}\\
{k_1}^{{\eta}}{q_i}^{{\eta}^{\prime}}&={\alpha_1}\beta_1 \:{p_i}^{{\eta}}{p_i}^{{\eta}^{\prime}}\\
{q_i}^{{\eta}}{k_1}^{{\eta}^{\prime}}&={\alpha_1}\beta_1 \:{p_i}^{{\eta}}{p_i}^{{\eta}^{\prime}}\\
