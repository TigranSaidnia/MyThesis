...
{k_1}^{{\eta}}{q_i}^{{\eta}^{\prime}}&=[\beta_1(1-\beta_1)-y {\beta_1}^2 (\frac{Q^2}{2p_i \cdot Q})] {p_i}^{{\eta}}{p_i}^{{\eta}^{\prime}}+y {\beta_1}^2 (\frac{Q^2}{2p_i \cdot Q}){Q}^{{\eta}}{p_i}^{{\eta}^{\prime}}\\
{q_i}^{{\eta}}{k_1}^{{\eta}^{\prime}}&=[\beta_1(1-\beta_1)-y {\beta_1}^2 (\frac{Q^2}{2p_i \cdot Q})] {p_i}^{{\eta}}{p_i}^{{\eta}^{\prime}}+y {\beta_1}^2 (\frac{Q^2}{2p_i \cdot Q}){p_i}^{{\eta}}{Q}^{{\eta}^{\prime}}\\
{q_i}^{{\eta}}{q_i}^{{\eta}^{\prime}}&={\beta_1}^2 {p_i}^{{\eta}}{p_i}^{{\eta}^{\prime}}\\
{k_1}^{{\eta}}{q_k}^{{\eta}^{\prime}}&= \sqrt{1-y}{p_i}^{{\eta}}{{p_k}^{{\eta}^{\prime}}}-y {\beta_1} (\frac{Q^2}{2p_i \cdot Q}) A_1 \:{p_i}^{{\eta}}{p_i}^{{\eta}^{\prime}}-y {\beta_1} (\frac{Q^2}{2p_i \cdot Q}) A_2\: {p_i}^{{\eta}}{Q}^{{\eta}^{\prime}}\\
&+y {\beta_1} A_1 \:{Q}^{{\eta}}{p_i}^{{\eta}^{\prime}}+y {\beta_1} A_2 \:{Q}^{{\eta}}{Q}^{{\eta}^{\prime}}\\
...
{q_k}^{\eta}{k_1}^{{{\eta}}^{\prime}}&=\sqrt{1-y}{p_i}^{{\eta}}{{p_k}^{{\eta}^{\prime}}}-y {\beta_1} (\frac{Q^2}{2p_i \cdot Q}) A_1 \:{p_i}^{{\eta}}{p_i}^{{\eta}^{\prime}}-y {\beta_1} (\frac{Q^2}{2p_i \cdot Q}) A_2\: {p_i}^{{\eta}}{Q}^{{\eta}^{\prime}}\\
&+y {\beta_1} A_1 \:{Q}^{{\eta}}{p_i}^{{\eta}^{\prime}}+y {\beta_1} A_2 \:{Q}^{{\eta}}{Q}^{{\eta}^{\prime}}\\
...
\begin{equation}
\begin{split}
&M_1{M_2}^{\dagger}=\frac{g_s^2 f^{\:l\:a\:o} f^{\:f\: o\:n} }{4(q_i\cdot q) (q_j \cdot q)}\\
&\lbrace g^{{{\eta}}{{\eta}^{\prime}}}({\alpha_1}^2+\alpha_1 \beta_1){p_i}^{{\gamma}}{p_i}^{\delta}-g^{{{\eta}}{{\eta}^{\prime}}}g^{{{\gamma}}{{\delta}}}({\alpha_1}^2+\alpha_1 \beta_1)p_i \cdot p_i+g^{{{\gamma}}{{\eta}^{\prime}}}({\alpha_1}^2+\alpha_1 \beta_1){p_i}^{{\eta}}{p_i}^{\delta}\\
&+g^{{{\eta}^{\prime}}{{\delta}}}({\alpha_1}^2+\alpha_1 \beta_1){p_i}^{{\eta}}{p_i}^{\gamma}-g^{{{\gamma}}{{\delta}}}({\alpha_1}^2+\alpha_1 \beta_1){p_i}^{\eta}{p_i}^{{\eta}^{\prime}}-g^{{{\gamma}}{{\eta}}}({\alpha_1}^2+\alpha_1 \beta_1){p_i}^{{\eta}^{\prime}}{p_i}^{{\delta}}\\
&-g^{{{\eta}}{{\delta}}}({\alpha_1}^2+\alpha_1 \beta_1){p_i}^{{\eta}^{\prime}}{p_i}^{{\gamma}}+g^{{{\gamma}}{{\delta}}}({\alpha_1}^2+\alpha_1 \beta_1){p_i}^{{\eta}}{p_i}^{{\eta}^{\prime}}\rbrace
\end{split}
\end{equation}
...
\begin{equation}
\begin{split}
&M_1{M_2}^{\dagger}=\frac{g_s^2 f^{\:l\:a\:o} f^{\:f\: o\:n} }{4(q_i\cdot q) (q_j \cdot q)}\lbrace g^{{{\eta}}{{\eta}^{\prime}}}({\alpha_1}^2+\alpha_1 \beta_1){p_i}^{{\gamma}}{p_i}^{\delta}+g^{{{\gamma}}{{\eta}^{\prime}}}({\alpha_1}^2+\alpha_1 \beta_1){p_i}^{{\eta}}{p_i}^{\delta}\\&+g^{{{\eta}^{\prime}}{{\delta}}}({\alpha_1}^2+\alpha_1 \beta_1){p_i}^{{\eta}}{p_i}^{\gamma}-g^{{{\gamma}}{{\eta}}}({\alpha_1}^2+\alpha_1 \beta_1){p_i}^{{\eta}^{\prime}}{p_i}^{{\delta}}-g^{{{\eta}}{{\delta}}}({\alpha_1}^2+\alpha_1 \beta_1){p_i}^{{\eta}^{\prime}}{p_i}^{{\gamma}}\rbrace
\end{split}
\end{equation}
