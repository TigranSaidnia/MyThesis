...
\begin{equation}
\begin{split}
|M_2|^2 =(d-2) \frac{g_s^2 \: {[T^c]_f}^m \: {[T^d]_{f^{\prime}}}^n }{(2qq_j)} [\not{q}]\: 
[\not{q_i} ]
\end{split}
\end{equation}
finally:
\begin{equation}
\begin{split}
|M_2|^2=-(d-2)yz^2\:\frac{g_s^2 \: {[T^c]_f}^m \: {[T^d]_{f^{\prime}}}^n }{2(1-z)(1-y)(p_i \cdot p_j)}
[\not{p_i}][\not{p_j}]
\end{split}
\end{equation}
\newpage
...
[\not{p_i}][\not{p_j}]\\
-(d-2)yz^2\:\frac{g_s^2 \: {[T^c]_f}^m \: {[T^d]_{f^{\prime}}}^n }{2(1-z)(1-y)(p_i \cdot p_j)}
[\not{p_i}][\not{p_j}]\\
