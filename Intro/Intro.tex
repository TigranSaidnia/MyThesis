...
Here i,j are color indices in the fundamental representation, a  color index in the adjoint representation of SU(3) respectively. f labels the six flavours of quarks. With The field-strength tensor for QCD by:
\begin{equation}
\begin{split}
