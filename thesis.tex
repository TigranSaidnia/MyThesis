...
\begin{picture}(0,0)
\put(0,-3){\includegraphics[height=0.7cm,width=1.2cm]{images/Intro/kitlogo_de_rgb}}
\end{picture}\put(14,2){\scriptsize\sf{Institute for Theoretical Physics}}\put(14,-2){\scriptsize\sf{Karlsruhe Institute of Technology (KIT)}}}
\cfoot{}
