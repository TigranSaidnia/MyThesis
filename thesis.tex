...
\chapter{Introduction to splitting function}
\input{singularities/singularities.tex}
\input{parametrisation/parametrisation.tex}
\newpage
\input{procedure.tex}
\chapter{anti-quark-gluon splitting from a parent quark}
\input{qq/qq.tex}
\newpage
\chapter{Gluon radiation from a parent quark}
\input{gg/gg.tex}
\chapter{A daughter gluon from a parent quark}
\input{gq/gq.tex} 
\chapter{quark-anti-quark splitting from a parent gluon}
\input{qg/qg.tex}  
