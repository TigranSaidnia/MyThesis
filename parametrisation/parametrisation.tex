\section{Mapping 3 partons to 2}
Define emitter and spectator
Vik;j depends on y and z
\section{Old mapping}
...
Finally we are going to compute the Lorenz transformation of the Momenta. The detailed calculation of them can be found in Annex A.
\begin{equation}
	\begin{aligned}
